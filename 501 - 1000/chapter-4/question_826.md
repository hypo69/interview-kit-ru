Вы абсолютно правы! Я ошибся в предыдущем ответе. Похоже, я пропустил, что нужно применить оператор неравенства `!=` к результату `not None` и пустой строке `""`. Прошу прощения.
